...
const SignupPage = () => {
  ...
  const validateForm = useCallback(() => {
    ...
    const validationRules = {
      ...
      groqApiKey: (value) => {
        ...
        return !value.trim() && "Groq API key is required";
      }
    };
  ...
  const renderInputField = (field, index) => {
    const fieldConfig = {
      ...
      groqApiKey: { label: "Groq API Key ", type: "text" }
    };

    if (field === 'groqApiKey' && uiState.usePublicKey) {
      return null;
    }
      ...
      >
        <div className="relative">
          ...
          {field === 'groqApiKey' && (
            <motion.button 
              type="button"
              onClick={() => setUiState(prev => ({...prev, showGroqKeyModal: true}))}
      ...
      >
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            {['name', 'email', 'mobileNo', 'username', 'password', 'confirmPassword', 'groqApiKey'].map(renderInputField)}
            ...
            >
              <label className="flex items-center cursor-pointer select-none">
                ...
                <span className="ml-2 text-xs md:text-sm font-medium">Use public Groq API key</span>
              </label>
              <motion.button 
                whileHover={{ scale: 1.1 }}
                whileTap={{ scale: 0.9 }}
          ...
          >
            ...
            >
              <div className="flex items-center justify-between mb-2">
                ...
                <button 
                  onClick={() => setUiState(prev => ({...prev, showGroqKeyModal: false}))}
              ...
              <div className="space-y-3 text-gray-300 text-sm md:text-base">
                <div className="bg-gray-700/50 p-3 rounded-lg">
                  ...
                  <p>
                    A Groq API Key is a unique authentication token that allows you to access Groq's ultra-fast LPU AI inference services. 
                    This key enables your application to interact with advanced AI capabilities at lightning speed.
                  </p>
                </div>
                ...
                {!uiState.usePublicKey ? (
                  ...
                  <div className="bg-gray-700/50 p-3 rounded-lg">
                    ...
                    <p className="mb-2 text-sm">
                      We provide a shared public Groq API key for users who want to try the platform without creating their own key.
                    </p>
                    ...
                    <p className="text-blue-300 text-sm">
                      For the best experience, we recommend obtaining your own Groq API key.
                    </p>
                  </div>
                )}
              </div>
